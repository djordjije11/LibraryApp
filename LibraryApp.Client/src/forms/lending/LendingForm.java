...
public class LendingForm extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTextField3.setText("Naslov");

        jTextField4.setText("ID Kopije");
        ...
        jTextField5.setText("ODABRANI CLAN");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LendingForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LendingForm dialog = new LendingForm(new javax.swing.JFrame(), true);
